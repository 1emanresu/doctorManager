 ...
 *	 id: 'circles', //要显示圆形进度条的元素id
 *	 value: 50, //百分比
 *	 radius: 65, //圆形的大小
 *	 width: 20, //圆形的线条粗细
 *	 colors: ['#F8F9B6', '#D2D558'] //圆形的颜色--数组类型
 *}));
 * author zhangqt 
 */
! function(a, b) {
	...
	return b.prototype = {
		...
		_setPercentage: function(a) {
			this._movingPath.setAttribute("d", this._calculatePath(a, !0)), this._textContainer.innerHTML = this._getText(this.getValueFromPercent(a)) + "%"//添加百分号
		},
		...
		_getText: function(a) {
			if(a==0){return "0%"}
			return this._text ? (void 0 === a && (a = this._value), a = parseFloat(a.toFixed(2)), "function" == typeof this._text ? a : this._text) : ""
		},
